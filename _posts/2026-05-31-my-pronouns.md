...
The use of he/him for Sean is to leave the least surprise for the reader. Sean is a common male name in English[^irish], so the reader is likely to expect "he"/"him" to refer to Sean.

[^irish]: Borrowed from _Seán_{:lang="ga"}, Irish's version of John.

Okay, but not recommended:

> **Sean Yen** is an infrequent player of _Minecraft_, a European voxel sandbox game. **Yen** has committed many unspeakable horrors to **his** _Minecraft_ villagers.
...
> <span lang="zh-TW" markdown="1">
> **SheepTester**的遊戲不好玩，**他**為什麼這麼喜歡用JS
> </span>
...
<!--  sparked by uncommon words, especially if it's related to a political topic in your community -->
