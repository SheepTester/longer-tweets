...
<figure>
<img src="../images/hide-seek-review/sf-bounds.png" alt="Screenshot of Google Maps" width="500">
<figcaption>
...
2. SF Caltrain stop: The hiders were found by China Basin Park because I recognized the unique windows of the building they were next to.
   ...
   <img src="../images/hide-seek-review/unique-windows.jpg" alt="Photo of a white apartment tower with non-rectangular windows, as seen from its base." width="220">
...
2. Even then, the hiders saw a place with a plane icon on Treasure Island ([Airport Authority Consulting][treasure-island]) and considered it an airport, but the rules say a commercial airport must be one whose flights are listed on Google Flights.
   ...
   <img src="../images/hide-seek-review/treasure-island.png" alt="Screenshot of Google Maps with a red airplane icon labelled 'Airport Authority Consulting' on Treasure Island." width="250">
...
3. In Chinatown, the seekers marked places with drama mask icons as theaters, although the question specifically specify "movie theater." Google Maps apparently has separate icons for performing arts theaters and movie theaters.
   ...
   <div class="images">
   <img src="../images/hide-seek-review/chinatown-theater.png" alt="Screenshot of Google Maps with a red drama mask icons in Chinatown." width="300">
   <img src="../images/hide-seek-review/amc-sd.png" alt="Screenshot of Google Maps with a red movie clip icons in San Diego." width="500">
   </div>
