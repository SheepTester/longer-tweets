...
## kramdown syntax testing

Jekyll uses Kramdown, which allegedly supports [special syntax](https://kramdown.gettalong.org/syntax.html)[^named-footnote].

[^named-footnote]: Interesting, I didn't know named footnotes were supported.

    > And you can put quotes in them?
...
![photo of leaves in rain](../images/background.jpg){: width="200"}

Inline code highlighting:
`console.log("hello gamers")`{:.language-js}
...
I need a better example for unordered lists. Here's one:

- The list items of this list
- are not paragraphs
- and thus the list appears more dense.
...
- and thus the list is more spaced out.
...
i want to compare the horizontal rule with the footnote rule
