...
Career-wise, I think that human programmers will still be needed in the long term, but way fewer than before, especially after the overhiring spree committed during Covid. After all, there'll still be industries where code, for safety or legal reasons, must be written by a human.
Plus, with [CS enrollment dropping][uc-cs-ucsd],[^ucsd-cs] surely the decrease in SWE supply will be in my favor.
I can only hope that I can stay ahead of the curve, which is why I still program manually.[^cope]

[^cope]: Or maybe I'm just coping.
